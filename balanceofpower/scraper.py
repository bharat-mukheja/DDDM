...
import csv
j = 0
ecof = open('data\\economy.csv', 'w', newline='')
geof = open('data\\geography.csv', 'w', newline='')
demf = open('data\\demographics.csv', 'w', newline='')
socf = open('data\\society.csv', 'w', newline='')
inff = open('data\\infrastructure.csv', 'w', newline='')
